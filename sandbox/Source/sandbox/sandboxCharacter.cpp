...
void AsandboxCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AsandboxCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AsandboxCharacter::TouchStopped);
...
void AsandboxCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void AsandboxCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
